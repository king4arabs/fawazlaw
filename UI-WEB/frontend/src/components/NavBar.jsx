      ...
      <div className=" w-[100%] flex h-12 bg-[#003E6F] justify-center items-center overflow-x-auto no-scrollbar">
        <div className="w-[90%] flex justify-between items-center">
          <div className={`flex flex-row items-center gap-3`}>
            <a href="https://twitter.com/fawazlawyer" target="_blank" rel="noreferrer" aria-label="Fawazlaw on X">
              <BsTwitterX size={20} className="  text-white" />
            </a>
            <span aria-label="Facebook profile pending">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              aria-label="Fawazlaw on Instagram"
            >
              <IoLogoInstagram size={22} className="  text-white" />
            </a>
            <span className=" flex" aria-label="LinkedIn profile pending">
            ...
            <a
              ...
              rel="noreferrer"
              className=" flex"
              aria-label="Fawazlaw on YouTube"
            >
