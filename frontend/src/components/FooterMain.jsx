    ...
    <div className="w-full flex flex-col justify-center items-center ">
      ...
      <div className=" w-full flex">
        <div className=" w-[80%] flex flex-col mx-auto">
          <div className=" w-full flex flex-col md:grid lg:grid-cols-5 grid-cols-2 gap-5 py-20">
            {activeLanguage == 'ar' ? (
              <>
                ...
                <div className=" flex flex-col gap-4">
                  ...
                  <p className=" text-[#000929] text-end text-lg font-medium opacity-55">
                    <Link to={'/contacts/tandc'}>الشروط والاحكام</Link>
                  </p>
                  <p className=" text-[#000929] text-end text-lg font-medium opacity-55">
                    <Link to={'/contacts/privacyPolicy'}>سياسية الخصوصية</Link>
                  </p>
                </div>
                <div className=" flex flex-col gap-4">
                  <h1 className=" text-2xl font-bold text-[#000929] text-end">
                  ...
                  <p className=" text-[#000929] text-end text-lg font-medium opacity-55">
                    <Link to={'/whatwedo'}>عن الشركة</Link>
                  </p>
                  <p className=" text-[#000929] text-end text-lg font-medium opacity-55">
              ...
              <>
                ...
                <div className=" flex flex-col gap-2">
                  ...
                  <p className=" text-[#000929] text-base font-medium opacity-55">
                    <Link to={'/contacts'}>Connect Us</Link>
                  </p>
                  <p className=" text-[#000929] text-base font-medium opacity-55">
                    <Link to={'/faq'}>FAQs</Link>
                  </p>
                  <p className=" text-[#000929] text-base font-medium opacity-55">
                    <Link to={'/contacts/tandc'}>Terms and conditions</Link>
                  </p>
                  <p className=" text-[#000929] text-base font-medium opacity-55">
                    <Link to={'/contacts/privacyPolicy'}>Privacy Policy</Link>
                  </p>
                </div>
                <div className=" flex flex-col gap-4">
                  ...
                  <div className=" flex flex-row-reverse gap-2">
                    <div>
                      ...
                      <p className=" text-base opacity-55">
                        Prince Muhammad bin Abdulaziz Street, Al-Basha Center,
                        Floor
                      </p>
                    </div>
                    <img
