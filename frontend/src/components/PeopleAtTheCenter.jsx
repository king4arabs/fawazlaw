    ...
    <div className="max-w-[100%] md:max-w-[70%]">
      <Swiper navigation={true} modules={[Navigation]} className="mySwiper">
        ...
        {/* <SwiperSlide
          ...
          className="justify-center"
        >
          <div className="min-h-[80px] w-[80%] flex items-center">
    ...
    <div className=" w-full flex bg-bggradient2 justify-center flex-col">
      <div className=" flex flex-col justify-center items-center w-[80%] gap-7  bg-transparent mx-auto  py-10 ">
        ...
        <p className=" font-medium text-[#000929]">
          {t('Muhammad Al-Salami')}{' '}
          <span className=" font-thin text-[#667085]">{t('information')} </span>
        </p>
        {/* <div className="flex flex-row gap-4 justify-center items-center">
          ...
          >
            <SwiperSlide>
              <div className="  bg-[red] min-h-[80px]">
                <img src="\Images\Imageman.png" alt="" />
              </div>
            </SwiperSlide>
            <SwiperSlide>
              <div className="  bg-[green] min-h-[80px]">
                <img src="\Images\Imagegirl.png" alt="" />
              </div>
            </SwiperSlide>
            <SwiperSlide>
              <div className="  bg-[blue] min-h-[80px]">
                <img src="\Images\Group 14073lined.png" alt="" />
              </div>
            </SwiperSlide>
