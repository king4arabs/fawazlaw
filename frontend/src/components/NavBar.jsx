      ...
      <div className=" w-[100%] flex h-12 bg-[#003E6F] justify-center items-center overflow-x-auto no-scrollbar">
        <div className="w-[90%] flex justify-between items-center">
          <div className={`flex flex-row items-center gap-3`}>
            ...
            <a href="https://www.instagram.com/fawazlawyer_/" target="_blank">
          ...
          <div className="hidden md:block group z-50">
            ...
            <div className="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-10">
