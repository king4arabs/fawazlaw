...
const HomeSection1 = () => {
  ...
  return (
    <div className="w-full my-20 px-5 md:px-14">
      <div className="w-[100%]">
        <div className="w-full flex flex-col">
          <div className={`subsection flex justify-between items-start`}>
            <div
              ...
              className={`arrowAndbutton flex items-center gap-1 pt-2 pl-2 ${
            ...
            <h1 className="text-[16px] md:text-[35px] font-bold w-fit pb-3">
              {t('homeSection1Title')}
            </h1>
          </div>
          <p
            className={`text-[16px] xl:mt-4 mt-1 pb-5 ${
              activeLanguage == 'ar' ? 'ml-auto' : ''
            }`}
          >
