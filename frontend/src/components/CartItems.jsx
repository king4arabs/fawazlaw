...
const CartCard = ({ title, content, price, onRemove, itm }) => {
  ...
  return (
    <div className=" w-[90%] shadow-top-darkRed py-8 pr-10 border-2 px-2 rounded-lg flex flex-col items-end justify-end">
            ...
            <h3
              className={`text-[18px] ${
                activeLanguage === 'ar' || activeLanguage === 'ur'
                  ? 'text-end'
                  : ''
              } max-w-sm mx-auto break-words text-[#667085] font-medium pr-3`}
            >
              {activeLanguage === 'ar' || activeLanguage === 'ur'
                ? content
                : itm.content_en}
