...
function validateSignature(body, myFatoorahSignature, myFatoorahSecret) {
    ...
    const result = (0, crypto_1.createHmac)('sha256', myFatoorahSecret).update(orderedString).digest();
