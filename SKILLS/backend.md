...
## Purpose
Backend standards for Laravel and Node/Express APIs, validation, errors, services, logging, scalability, and API contracts.
...
Fawazlaw.sa currently combines React CRA, Laravel 10, and a Node/Express API prototype. Any backend work must acknowledge this mixed state, avoid false claims about unimplemented capabilities, and improve clarity around the chosen future architecture.
