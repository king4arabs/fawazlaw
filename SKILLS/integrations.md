...
## Purpose
Integration standards for payments, email, CRM, automation, webhooks, SDK/API docs, and government API readiness.
...
Fawazlaw.sa currently combines React CRA, Laravel 10, and a Node/Express API prototype. Any integrations work must acknowledge this mixed state, avoid false claims about unimplemented capabilities, and improve clarity around the chosen future architecture.
