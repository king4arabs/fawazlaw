...
## Purpose
QA standards for unit, integration, E2E, regression, accessibility, security, performance, and manual release verification.
...
Fawazlaw.sa currently combines React CRA, Laravel 10, and a Node/Express API prototype. Any qa work must acknowledge this mixed state, avoid false claims about unimplemented capabilities, and improve clarity around the chosen future architecture.
