...
## Purpose
Frontend engineering standards for React CRA, future Next/Vue options, Tailwind/DaisyUI, bilingual RTL/LTR UX, accessibility, SEO, and performance.
...
Fawazlaw.sa currently combines React CRA, Laravel 10, and a Node/Express API prototype. Any frontend work must acknowledge this mixed state, avoid false claims about unimplemented capabilities, and improve clarity around the chosen future architecture.
