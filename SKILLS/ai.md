...
## Purpose
AI standards for safe legal assistant planning, prompts, RAG, hallucination control, human review, disclaimers, and evaluation.
...
Fawazlaw.sa currently combines React CRA, Laravel 10, and a Node/Express API prototype. Any ai work must acknowledge this mixed state, avoid false claims about unimplemented capabilities, and improve clarity around the chosen future architecture.
