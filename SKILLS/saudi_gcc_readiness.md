# Saudi Gcc Readiness Skill

## Purpose
Saudi/GCC readiness standards for Arabic-first UX, Hijri/Gregorian, Saudi payments, regional hosting, legal terminology, and enterprise procurement.
...
Fawazlaw.sa currently combines React CRA, Laravel 10, and a Node/Express API prototype. Any saudi gcc readiness work must acknowledge this mixed state, avoid false claims about unimplemented capabilities, and improve clarity around the chosen future architecture.
