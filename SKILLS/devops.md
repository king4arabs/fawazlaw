...
## Purpose
DevOps standards for GitHub Actions, environments, dependency installs, deployments, Docker readiness, rollback, and release safety.
...
Fawazlaw.sa currently combines React CRA, Laravel 10, and a Node/Express API prototype. Any devops work must acknowledge this mixed state, avoid false claims about unimplemented capabilities, and improve clarity around the chosen future architecture.
