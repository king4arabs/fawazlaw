...
## Purpose
Compliance standards for Saudi PDPL, legal services confidentiality, consent, records, auditability, and regulatory readiness.
...
Fawazlaw.sa currently combines React CRA, Laravel 10, and a Node/Express API prototype. Any compliance work must acknowledge this mixed state, avoid false claims about unimplemented capabilities, and improve clarity around the chosen future architecture.
