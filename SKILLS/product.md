...
## Purpose
Product management standards for discovery, prioritization, requirements, user stories, acceptance criteria, and roadmap governance.
...
Fawazlaw.sa currently combines React CRA, Laravel 10, and a Node/Express API prototype. Any product work must acknowledge this mixed state, avoid false claims about unimplemented capabilities, and improve clarity around the chosen future architecture.
