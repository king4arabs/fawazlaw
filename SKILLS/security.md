...
## Purpose
Security engineering standards for secrets, auth, rate limits, headers, WAF, dependency scanning, audit logs, and vulnerability response.
...
Fawazlaw.sa currently combines React CRA, Laravel 10, and a Node/Express API prototype. Any security work must acknowledge this mixed state, avoid false claims about unimplemented capabilities, and improve clarity around the chosen future architecture.
