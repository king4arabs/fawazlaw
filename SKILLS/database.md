...
## Purpose
Database standards for Eloquent/Mongo models, schema design, migrations, indexing, integrity, backups, privacy, caching, and query tuning.
...
Fawazlaw.sa currently combines React CRA, Laravel 10, and a Node/Express API prototype. Any database work must acknowledge this mixed state, avoid false claims about unimplemented capabilities, and improve clarity around the chosen future architecture.
